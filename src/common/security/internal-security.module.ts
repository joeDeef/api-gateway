...
import { EnvelopePackerService } from './envelopePacker.service';
...
@Module({
  ...
  providers: [EnvelopePackerService, JwtValidatorService],
  exports: [EnvelopePackerService,JwtValidatorService], // Permite que otros módulos lo inyecten
})
